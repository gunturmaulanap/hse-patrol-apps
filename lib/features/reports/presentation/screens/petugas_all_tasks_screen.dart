          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: TabBarView(
                  children: [
                    _buildTaskList(db.reports, 'All'),
                    _buildTaskList(db.reports, 'Pending'),
                    _buildTaskList(db.reports, 'Follow Up Done'),
                    _buildTaskList(db.reports, 'Completed'),
                    _buildTaskList(db.reports, 'Canceled'),
                  ],
                ),
              ),
            ],
