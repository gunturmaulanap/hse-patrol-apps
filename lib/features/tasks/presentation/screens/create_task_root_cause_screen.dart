...
class CreateTaskRootCauseScreen extends ConsumerStatefulWidget {
  const CreateTaskRootCauseScreen({super.key});

  @override
  ConsumerState<CreateTaskRootCauseScreen> createState() => _CreateTaskRootCauseScreenState();
}

class _CreateTaskRootCauseScreenState extends ConsumerState<CreateTaskRootCauseScreen> {
  final _rootCauseController = TextEditingController();

  @override
  void initState() {
    super.initState();
    _rootCauseController.text = ref.read(createTaskFormProvider).rootCause ?? '';
  }
