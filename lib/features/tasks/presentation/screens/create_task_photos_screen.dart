...
class CreateTaskPhotosScreen extends ConsumerStatefulWidget {
  const CreateTaskPhotosScreen({super.key});

  @override
  ConsumerState<CreateTaskPhotosScreen> createState() => _CreateTaskPhotosScreenState();
}

class _CreateTaskPhotosScreenState extends ConsumerState<CreateTaskPhotosScreen> {
                    ...
                    Expanded(
                      child: AppButton(
                        ...
                        onPressed: draft.photos.isNotEmpty && !_isProcessing
                            ? () => context.pushNamed(RouteNames.petugasCreateTaskNotes)
                            : null,
                      ),
                    ),
                  ],
  ...
  Widget _buildPhotoSlot(CreateTaskDraft draft, int index) {
    final hasPhoto = index < draft.photos.length;
